...
const latestReleaseInformation = await fetch("https://api.github.com/repos/Enhancecord/Enhancebop/releases/latest", {
    headers: {
...
const metaInfo = await fs.readFile("./meta/io.github.enhancecord.enhancebop.metainfo.xml", "utf-8");
...
await fs.writeFile("./meta/io.github.enhancecord.enhancebop.metainfo.xml", output, "utf-8");
